...
insert  into `report`(`id`,`rid`,`pname`,`pemail`,`dname`,`demail`,`sym`,`disp`,`report`,`date`,`status`,`action`,`pkey`) values (1,1,'preeti','preeti@gmail.com','nakku','nakku@gmail.com','fever','report','�&5;��r3ׁ\r�z;��','2023-09-17','Complated','Close','4a5eb52c');
